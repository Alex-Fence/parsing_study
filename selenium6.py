...
# Извлечение Сокровища: После нажатия на кнопку, результат появится в теге <p id="result">Result</p>. Скопируйте
# это значение и вставьте полученный код в поле ответа степик.
